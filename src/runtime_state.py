...
def read_runtime_state(state_file=STATE_FILE, logger=None):
...
def write_runtime_state(status, reason=None, details=None, pid=None, state_file=STATE_FILE, logger=None):

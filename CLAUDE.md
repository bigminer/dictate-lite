...
| File | Purpose |
|------|---------|
| `src/dictate.py` | Main app - system tray, hotkey, transcription |
| `src/speak.py` | Edge TTS text-to-speech utility |
| `src/config.py` | User configuration - generated by install.bat |
